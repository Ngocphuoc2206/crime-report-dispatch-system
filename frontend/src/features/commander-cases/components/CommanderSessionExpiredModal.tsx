    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 px-6 backdrop-blur-sm">
      <section className="w-full max-w-xl rounded-xl border border-slate-200 bg-white shadow-2xl">
        <div className="p-8 text-center">
          <div className="mx-auto flex size-20 items-center justify-center rounded-2xl border border-red-200 bg-red-50 text-4xl font-bold text-[var(--primary)]">
            !
          </div>
          ...
          <p className="mt-3 leading-7 text-slate-600">
            Phiên cập nhật hồ sơ đã hết hạn. Bạn có muốn thử khoá lại hồ sơ
            không?
          </p>
